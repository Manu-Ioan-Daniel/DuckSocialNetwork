...
public class Services {
    ...
    private static final NotificationService notificationsService = new NotificationService(new DbNotificationRepo());
    private static final ChatService chatService = new ChatService(usersService,messageService,notificationsService);
    private static final CommunityService communityService = new CommunityService(usersService,friendRequestService,friendshipService,notificationsService);
    private static final EventService eventService = new EventService(usersService,notificationsService,new DbEventRepo());
    ...
    public static NotificationService getNotificationService() { return notificationsService;}
